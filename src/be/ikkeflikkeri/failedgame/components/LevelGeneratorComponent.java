...
public class LevelGeneratorComponent extends GameComponent
{
	...
	public LevelGeneratorComponent(String filename)
	{
	...
	public void update(float delta)
	{
		if(!generated)
		{
			getParent().addChild(new MeshObject(new Mesh(vertices.toArray(new Vertex[0]), Utilities.toIntArray(indices.toArray(new Integer[0])), true), new Material("bricks.jpg", 0, 8)));
			generated = true;
		}
	}
